...
namespace Straight.Core.Sample.RealEstateAgency.Test.Common.Server
{
    public static class PersonaAddress
    {
        ...
        public static Address RueJoubertParis { get; } = new Address("Rue Joubert", "8", "Appartement 2", "75009",
            "Paris");

        public static Address LexingtonAvenue { get; } = new Address("51° Street/Lexington Avenue", "77", "", "10024",
            "New York");
    }
