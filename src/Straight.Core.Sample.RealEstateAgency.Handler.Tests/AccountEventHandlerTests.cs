...
namespace Straight.Core.Sample.RealEstateAgency.Handler.Tests
{
    ...
    public class AccountEventHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            _readRepository.Add(PersonaHouse.ApartmentParis as House.Domain.House);
        ...
        public void Should_raise_visit_house_at_account_when_add_visit_at_house()
        {
            ...
            Assert.That(virginie.GetChanges().First().GetType(), Is.EqualTo(typeof(Account.EventStore.Events.VisitAdded)));
        }
