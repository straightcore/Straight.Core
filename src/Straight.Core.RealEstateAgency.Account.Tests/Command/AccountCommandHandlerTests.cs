...
using System;
using System.Linq;
using AttachCustomersCommand = Straight.Core.RealEstateAgency.Contracts.Messages.Account.AttachCustomersCommand;
using UpdateCustomersCommand = Straight.Core.RealEstateAgency.Contracts.Messages.Account.UpdateCustomersCommand;
