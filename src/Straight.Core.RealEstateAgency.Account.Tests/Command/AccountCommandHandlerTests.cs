...
using Straight.Core.RealEstateAgency.Test.Common.Dto;
using Straight.Core.RealEstateAgency.Test.Common.Server;

namespace Straight.Core.RealEstateAgency.Account.Tests.Command
{
    [TestFixture]
    public class AccountCommandHandlerTests
    {
        ...
        private void GenerateAccountEvent()
        {
            ...
            account.Update(new Domain.Command.CreateAccountCommand()
            {
        ...
        {
            _commandHandler.Handle(new CreateAccountCommand()
            {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle((CreateAccountCommand)null));
        ...
        {
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new CreateAccountCommand()));
            ...
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new CreateAccountCommand() { Customers = new CustomerDto[0] }));
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new AttachCustomersCommand() { Customers = new CustomerDto[0] }));
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new UpdateCustomersCommand() { Customers = new CustomerDto[0] }));

            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new CreateAccountCommand() { Customers = new CustomerDto[1] { PersonaCustomerDto.Virginie } }));
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new AttachCustomersCommand() { Customers = new CustomerDto[1] { PersonaCustomerDto.Virginie } }));
            Assert.Throws<ArgumentNullException>(() => _commandHandler.Handle(new UpdateCustomersCommand() { Customers = new CustomerDto[1] { PersonaCustomerDto.Virginie } }));
        }
